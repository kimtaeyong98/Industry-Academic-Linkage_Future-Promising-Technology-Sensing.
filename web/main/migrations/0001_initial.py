...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Stopwords',
            fields=[
                ('stopword', models.CharField(max_length=20000, primary_key=True, serialize=False)),
            ],
            options={
                'db_table': 'stopwords',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('column1', models.CharField(blank=True, max_length=20000, null=True)),
            ],
            options={
                'db_table': 'table1',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('searchq', models.TextField(blank=True, null=True)),
            ],
            options={
                'db_table': 'total',
                'managed': False,
